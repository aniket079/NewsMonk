    ...
    return (
      <div style={gradientStyle}>
        ...
        <div className="container my-3">
          <h1 className="text-center text-uppercase  my-3" style={Style}><span>{this.props.category}</span><span></span></h1>
          ...
          <div className="d-flex justify-content-between">
            <button type="button" disabled={this.state.page <= 1} className="btn btn-dark" onClick={this.handleprevious}>&laquo; Previous</button>
            <button type="button" disabled={this.state.page + 1 > Math.ceil(this.state.totalResults / this.props.pageSize)} className="btn btn-dark" onClick={this.handlenext}>Next &raquo;</button>
          </div>
        </div>
